...
Ä ÄG     Ä     ( ./ª ¿ ¡ ¬»Ä…   ÀNÃ Õœ – ¸ˇˇdebug parm=debug:Debug level (0-2) parmtype=debug:int license=GPL v2 author=Mauro Carvalho Chehab description=Texas Instruments TVP5150A/TVP5150AM1/TVP5151 video decoder driver              §ˇ      GCC: (GNU) 11.2.0           GNU  ¿       ¿                   